...
public class test {
	public static void main(String[] args) throws MidiUnavailableException, InvalidMidiDataException, IOException {
		int tempo = 60 + (int) (120 * Math.random());
		...
		Pattern pattern = rhythm.getPattern().setTempo(80);
		Pattern pattern2 = new Pattern("I[ELECTRIC_BASS_PICK] Gq Eq Eh | Fq Dq Dh | Cq Dq Eq Fq | Gq Gq Gh | Gq Eq Eh | Fq Dq Dh");
		pattern2.setTempo(80);
		pattern.repeat(4);
